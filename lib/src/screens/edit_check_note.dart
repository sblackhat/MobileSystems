...
class _EditCheckNoteState extends State<EditCheckNote> {
  ...
  loadNoteItems() {
    checkListNote = Hive.box<CheckListNote>(opt.checkListDB)
        .values
                  ...
                  leading: Checkbox(
                    ...
                    onChanged: (bool value) async {
                      ...
                      Box<CheckListNote> clNotes =
                          Hive.box<CheckListNote>(opt.checkListDB);
  ...
  reorderNotesNewPosition(oldIndex, newIdenx) async {
    Box<CheckListNote> clNotes = Hive.box<CheckListNote>(opt.checkListDB);
  ...
  getUpdateItemInfo(CheckListNote item) {
    item = Hive.box<CheckListNote>(opt.checkListDB)
        .values
...
class CheckListItemText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    CheckListNote checkListItem = Hive.box<CheckListNote>(opt.checkListDB)
        .values
