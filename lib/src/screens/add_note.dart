...
final String notesBox = "FlutterNotesDB";
  ...
  createCheckListNote(BuildContext context) async {
    if (_formKey.currentState.validate()) {
      ...
      Box<CheckListNote> clNotes = Hive.box<CheckListNote>(options.checkListDB);
